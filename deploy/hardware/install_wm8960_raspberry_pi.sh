...
# See hardware/lafvin_hat/wm8960/v2/PROFILE.md for profile maintenance.
...
ZIP_NAME="${PROJECT_ROOT}/hardware/lafvin_hat/wm8960/v2/lafvin-hat-wm8960-v2.zip"
ASSUME_YES=false
...
cd "$EXTRACT_DIR/lafvin-hat-wm8960-v2"
STEP[unzip]="ok"
...
ensure_line_in_file "$BOOT_CONFIG" "dtoverlay=i2s-mmap" ACTION_I2S_OVERLAY
ensure_line_in_file \
